  ...
  return (
    <group>
      ...
      <mesh position={[0, 0.16, -0.01]}>
        ...
        <meshStandardMaterial color={BODY} roughness={0.38} metalness={0.18} />
      </mesh>
      <mesh position={[0, 0.12, 0.085]}>
        <boxGeometry args={[0.15, 0.1, 0.02]} />
        <meshStandardMaterial color={STEEL} roughness={0.28} metalness={0.55} />
      </mesh>
      ...
      <mesh position={[0, 0.34, -0.02]}>
        ...
        <meshStandardMaterial color="#1c1a18" roughness={0.35} />
      </mesh>
      <mesh position={[0, 0.045, 0.13]}>
        <cylinderGeometry args={[0.028, 0.024, 0.045, 12]} />
        <meshStandardMaterial color="#f4ead4" roughness={0.55} />
      </mesh>
  ...
  return (
    <group>
      ...
      <mesh position={[0, 0.84, 0.162]}>
        ...
        <meshStandardMaterial color="#7eb7d8" roughness={0.25} transparent opacity={0.7} />
      </mesh>
      ...
      <mesh position={[-0.045, 0.5, 0.17]} rotation={[Math.PI / 2, 0, 0]}>
        ...
        <meshStandardMaterial color="#3d7eb8" roughness={0.3} metalness={0.45} />
      </mesh>
      <mesh position={[0.045, 0.5, 0.17]} rotation={[Math.PI / 2, 0, 0]}>
        <cylinderGeometry args={[0.014, 0.014, 0.08, 8]} />
        <meshStandardMaterial color="#c45c4a" roughness={0.3} metalness={0.45} />
      </mesh>
      <mesh position={[-0.045, 0.5, 0.21]}>
        <sphereGeometry args={[0.018, 8, 8]} />
        <meshStandardMaterial color="#3d7eb8" roughness={0.35} />
      </mesh>
      <mesh position={[0.045, 0.5, 0.21]}>
        <sphereGeometry args={[0.018, 8, 8]} />
        <meshStandardMaterial color="#c45c4a" roughness={0.35} />
      </mesh>
      ...
      <mesh position={[0, 0.18, 0.165]}>
        ...
        <meshStandardMaterial color="#e8f2fa" roughness={0.45} />
      </mesh>
    </group>
  )
}
  ...
  return (
    <group position={position} rotation={[0, rotationY, 0]}>
      <mesh position={[0.12, 0.026, 0.38]} rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <meshStandardMaterial color="#dcc9a8" roughness={0.9} />
      </mesh>
      ...
      {[-0.28, 0.28].map((x) => (
        <mesh key={`knob-${x}`} position={[x + 0.16, h * 0.45, d / 2 - 0.015]}>
          <sphereGeometry args={[0.018, 8, 8]} />
          <meshStandardMaterial color={STEEL} roughness={0.3} metalness={0.5} />
        </mesh>
      ))}
      <mesh position={[0, h, 0]}>
        <boxGeometry args={[w + 0.06, 0.045, d + 0.04]} />
        <meshStandardMaterial color={TOP} roughness={0.48} />
      </mesh>
      ...
      <mesh position={[0.28, h + 0.012, 0.04]}>
        ...
        <meshStandardMaterial color="#9aa3a8" roughness={0.35} metalness={0.4} />
      </mesh>
      <mesh position={[0.28, h - 0.04, 0.04]}>
        <cylinderGeometry args={[0.055, 0.05, 0.08, 16]} />
        <meshStandardMaterial color="#6d7a80" roughness={0.3} metalness={0.35} />
      </mesh>
