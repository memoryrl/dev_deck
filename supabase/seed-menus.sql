...
BEGIN
  ...
  VALUES ('AI Prompt', 'mega.prompt.label', NULL, 'header', 'visitor', true, 0)
  ...
  INSERT INTO devdeck.menus (label, label_key, href, location, view_role, is_active, sort_order)
  VALUES ('커리어로그', 'mega.career.label', NULL, 'header', 'visitor', true, 10)
  ...
  INSERT INTO devdeck.menus (label, label_key, href, location, view_role, is_active, sort_order)
  VALUES ('게임리뷰', 'mega.games.label', NULL, 'header', 'visitor', true, 20)
  ...
  INSERT INTO devdeck.menus (label, label_key, href, location, view_role, is_active, sort_order)
  VALUES ('커뮤니티', 'mega.community.label', NULL, 'header', 'visitor', true, 30)
  RETURNING id INTO id_community;

  INSERT INTO devdeck.menus (parent_id, board_id, label, label_key, href, location, view_role, is_active, sort_order) VALUES
    (id_community, id_notice, '공지사항', 'mega.community.notice', NULL, 'header', 'visitor', true, 0),
    (id_community, id_free, '자유게시판', 'mega.community.free', NULL, 'header', 'visitor', true, 10);

  INSERT INTO devdeck.menus (label, label_key, href, location, view_role, is_active, sort_order)
  VALUES ('둘러보기', 'footer.browse', NULL, 'footer', 'visitor', true, 0)
  RETURNING id INTO id_browse;

  INSERT INTO devdeck.menus (parent_id, label, label_key, href, location, view_role, is_active, sort_order) VALUES
    (id_browse, '홈', 'common.home', '/', 'footer', 'visitor', true, 0),
    (id_browse, '커리어', 'footer.career', '/work', 'footer', 'visitor', true, 10),
    (id_browse, '게임', 'footer.games', '/games', 'footer', 'visitor', true, 20);

  INSERT INTO devdeck.menus (label, label_key, href, location, view_role, is_active, sort_order)
  VALUES ('PromptKit', 'nav.promptkit', NULL, 'footer', 'visitor', true, 10)
  ...
  INSERT INTO devdeck.menus (label, label_key, href, location, view_role, is_active, sort_order)
  VALUES ('CareerLog', 'nav.career', NULL, 'footer', 'visitor', true, 20)
  ...
  INSERT INTO devdeck.menus (label, label_key, href, location, view_role, is_active, sort_order)
  VALUES ('커뮤니티', 'mega.community.label', NULL, 'footer', 'visitor', true, 40)
  RETURNING id INTO id_community_footer;

  INSERT INTO devdeck.menus (parent_id, board_id, label, label_key, href, location, view_role, is_active, sort_order) VALUES
    (id_community_footer, id_notice, '공지사항', 'mega.community.notice', NULL, 'footer', 'visitor', true, 0),
    (id_community_footer, id_free, '자유게시판', 'mega.community.free', NULL, 'footer', 'visitor', true, 10);
